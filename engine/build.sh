...
EXPORTS='["_ami_init","_ami_sample_l","_ami_sample_r","_ami_sample_capacity","_ami_out_l","_ami_out_r","_ami_set_sample","_ami_set_param","_ami_note_on","_ami_note_off","_ami_all_notes_off","_ami_process","_ami_active_voices","_ami_playhead"]'
